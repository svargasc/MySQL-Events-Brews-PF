      ...
      <div className="h-screen bg-[url('https://i.ibb.co/LQf91TG/fondo-EB.webp')] bg-cover bg-center flex flex-col justify-center items-center">
        <div className="flex justify-around items-center bg-[#0000007c] w-4/5 h-3/4 rounded-2xl border-4 border-[#AC703E]">
          ...
          >
            ...
            ></textarea>
            <button className="bg-[#FFEEB3] text-[#AC703E] text-xl m-2 font-bold h-12 w-1/3 rounded-full mt-2 hover:bg-[#AC703E] hover:text-[#FFEEB3] duration-300">
              Subir evento
            </button>
          </form>
          <input
            className="border-4 border-[#AC703E] w-1/5 h-2/5 rounded-full hover:cursor-pointer"
            type="file"
          />
        </div>
      </div>
